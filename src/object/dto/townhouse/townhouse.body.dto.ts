...
class TownhousePropertyBodyDto implements Omit<ITownhouseProperty, 'id'> {
...
export class TownhouseBodyDto extends ObjectBodyDto implements Omit<ITownhouse, 'id' | 'createAt' | 'updateAt' | 'views' | 'property' | 'legalPurity' | 'favorite' | 'city' | 'complex' |'markAsDelete'>  {
  ...
  @ApiProperty({ type: TownhousePropertyBodyDto })
  @IsOptional()
  property: TownhousePropertyBodyDto;
